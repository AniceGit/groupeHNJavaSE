...
public class Debit extends Flux {
	...
	public Debit(String commentaire, String identifiant, double montant, int numero_compte_cible, boolean effectue,
	...
	public String toString() {
		return "Débit [commentaire=" + commentaire + ", identifiant=" + identifiant + ", montant=" + montant
