...
public abstract class Flux {
	...
	protected int numero_compte_cible;
	protected boolean effectue;
	LocalDateTime date_flux = LocalDateTime.now();
	public Flux() {
		super();
	}

	public Flux(String commentaire, String identifiant, double montant, int numero_compte_cible, boolean effectue,
	...
	public Compte getCompte_emetteur() {
		return this.getCompte_emetteur();
	}
